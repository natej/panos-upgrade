...
DEFAULT_JOB_STALL_TIMEOUT = 1800  # Timeout when job shows no progress
...
DEFAULT_VALIDATION_RETRY_ATTEMPTS = 3
DEFAULT_VALIDATION_RETRY_DELAY = 10  # Initial delay in seconds
DEFAULT_VALIDATION_RETRY_BACKOFF = 2.0  # Backoff multiplier
